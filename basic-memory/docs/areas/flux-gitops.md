...
- [claim] "Flux Operator manifests pinned (version constraint 2.x); Renovate-tracked via inline annotation" (evidence: repo, ref: flux-instance/app/helmrelease.yaml:15-17, verified: 2026-05-19)
