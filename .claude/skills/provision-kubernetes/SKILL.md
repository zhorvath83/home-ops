...
description: Work on the Ansible-based cluster provisioning area in the home-ops repository. Use when modifying inventory, playbooks, templates, Ansible dependency files, or task-backed workflows under provision/kubernetes for host preparation, cluster installation, reboot, or lifecycle operations.
---
