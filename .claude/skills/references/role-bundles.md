...
Use this reference when a task maps naturally to an agent-like specialization. The repo does not assume a static repo-local agent runtime; instead, compose skills into named role bundles.
